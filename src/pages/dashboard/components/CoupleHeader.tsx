...
export default function CoupleHeader({ couple, counts, onAnniversarySave }: Props) {
  ...
  return (
    <section className="rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-sm font-medium text-rose-600">Adriana e Ivan</p>
          <h1 className="m-0 text-2xl font-semibold text-slate-950">{couple?.name ?? "Mi historia contigo"}</h1>
